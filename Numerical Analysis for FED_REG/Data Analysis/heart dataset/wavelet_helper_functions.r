...
#     <U+2022> Optionally re-weights by 1/ p<U+0302>(Xi) where p<U+0302> is a KDE
#     <U+2022> Adds Laplace noise to the KDE for <U+03B5>-DP
# ------------------------------------------------------------------
...
#' @param use_kde_weights Logical flag indicating whether KDE-based inverse-density weights are used.
#' @param kde_eps Privacy budget used for the KDE noise step.
#' @param bandwidth Kernel bandwidth used in the density estimate.
#' @param kde_floor Lower bound applied to the estimated density before inversion.
...
estimate_wavelet_coefficient <- function(Y, X, psi,
                                         ...
                                         kde_eps          = Inf, # <U+03B5> for KDE; Inf <U+21D2> no privacy noise
                                         ...
                                         kde_floor        = 0.5) # floor to avoid divide-by-zero
{
  ...
  # Map integer indices X <U+2208> {1,<U+2026>,grid_size} back to [0,1]
  ...
  # ---- 4. Add Laplace noise for <U+03B5>-DP if requested ---------------
...
#' @param kde_floor Lower bound used for KDE-based inverse-density weighting.
